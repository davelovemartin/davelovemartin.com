...
Our brains have two modes. Daniel Kahneman calls these system one and two in his book, Thinking Fast and Slow. I prefer the descriptions, focussed and diffuse.
...
Switching between being focussed and a more relaxed diffuse mode is a great way to learn. The diffuse mode of thinking allows you to form new neural pathways.
...
- gain context so you can see not just how but also when to use this chunk.
- go beyond the initial problem and look more broadly - note the headings of a book passage before diving in to the detail,
...
Our brains learn by repetition, not cramming. Use the pomodoro method to intensely focus on learning something. Then take a break. Our brains use the diffuse mode to build new connections.
...
Practicing using spaced repetition is used to transfer working memory to long term memory. Hand-writing and saying what you've learned seems to enhance retention.
