...
description: How to dopamine rules your life and what you need to do to change
stage: note
...
By the way, if you want a more scientific explanation of these things...  [link to website]

## How your reward system works and why layering is bad

Tonic and phasic release... tonic is your baseline [expand]

Volumemetric release and local synaptic release.
...
We lose that tolerance that we build up and we start to enjoy the mundane.
