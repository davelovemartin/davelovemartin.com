...
_to do: graphic showing a shape_

_to do: graphic showing a shape, translated_

_to do: graphic showing a shape, rotated_

_to do: graphic showing a shape, skewed_

_to do: graphic showing a shape, scaled_

### Animating transforms

> to do: _explain the animateTransform elements_
