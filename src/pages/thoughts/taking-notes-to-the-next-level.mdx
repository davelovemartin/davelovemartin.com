...
Note taking becomes more powerful if we reflect on what we've learned.
...
As opposed to a blog, which is typically a reverse-chronological list of published articles, I'm advocating creating a digital garden.

A digital garden is a bunch of interconnected notes and essays that readers can peruse through links. It's how we naturally browse the internet.

Each time I find something interesting on the internet. I'm going to stop and make some notes and plant them in my digital garden.

Sowing the seeds of ideas in pure note form can be the end of it. Or notes can be nutured into more rounded reflective essays over time.
...
But how do we retain and remember that information?
...
By regularly returning to read and <a href="./the-perfect-post">transforming notes for others to read</a>, we strenghen the ideas and reenforce that knowledge.

And publishing the notes and essays opens them up to the opportunity for feedback and further improvement.
